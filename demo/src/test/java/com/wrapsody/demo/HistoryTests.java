...
public class HistoryTests {
    ...
    static final String SERVER_URL = "localhost:8080/history";
    ...
    public void getTop20HistoryTest() throws IOException {
        HttpUriRequest request =  new HttpGet(SERVER_URL + "?" + USER_ID);
    ...
    @Test
    public void createHistoryTest() throws UnsupportedEncodingException, IOException {
